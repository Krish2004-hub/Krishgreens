...
import com.springboot_practice.Spring.security.JwtUtil;
...
public class AuthController {
	...
	public ResponseEntity<Map<String, String>> login(@RequestBody UserEntity user) {
		try {
			...
			return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(Map.of("error", "Invaild Username or Passowrd"));
		}
